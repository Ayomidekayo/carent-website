...
const CarCard = ({car}) => {
  ...
  return (
   <div onClick={()=>{navigate(`/car-details/${car._id}`)}} className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
       ...
       {car.isAvaliable  &&  <p className='absolute top-4 left-4 bg-blue-700  text-white text-xs px-2.5 py-1 rounded-full'>Available Now</p>}

       <div className='absolute bottom-4 left-4 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg flex flex-col gap-1'>
       ...
       <div className='p-4  sm:p-5 '>
          ...
          <div className='mt-4 grid grid-cols-2 gap-y-2 text-gray-600 '>
              <div className='itcems-center flex text-sm bg-slate-500/10 rounded-full px-2 py-1 w-max'>

    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-24 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
            ...
            className='lg:col-span-2'>
                ...
                transition={{duration:0.5}}
                  src={car.image} 
                  className="w-full h-[70vh] object-cover rounded-xl mb-6 shadow-md" 
              ...
              className='space-y-6'>
                 ...
                 <hr className='border-borrderColor my-6'/>
            ...
            onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
             ...
             <div className='flex flex-col gap-2'>
               ...
               <input value={pickupDate} onChange={(e)=>setPickupDate(e.target.value)} type="date" className='border border-borrderColor px-3 py-2 rounded-lg' required id='pick-date' min={new Date().toISOString().split('T')[0]} />
             </div>

             <div className='flex flex-col gap-2'>
               <label htmlFor="retunr-date">Return Date</label>
               <input value={returnDate} onChange={(e)=>setReturnDate(e.target.value)} type="date" className='border border-borrderColor px-3 py-2 rounded-lg' required id='return-date' />
             </div>
